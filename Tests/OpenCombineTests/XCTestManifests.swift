...
extension EnumerateFieldsTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__EnumerateFieldsTests = [
        ("testClassNoFields", testClassNoFields),
        ("testClassVarsAndLets", testClassVarsAndLets),
        ("testClassWithFieldsOfResilientTypes", testClassWithFieldsOfResilientTypes),
        ("testForeignClass", testForeignClass),
        ("testGenericClass", testGenericClass),
        ("testGenericStruct", testGenericStruct),
        ("testGenericSubclassOfGenericClass", testGenericSubclassOfGenericClass),
        ("testGenericSubclassOfNonGenericResilientClass", testGenericSubclassOfNonGenericResilientClass),
        ("testNSObjectSubclass", testNSObjectSubclass),
        ("testObjCClass", testObjCClass),
        ("testRegularDerivedClass", testRegularDerivedClass),
        ("testRegularDerivedClassEarlyExit", testRegularDerivedClassEarlyExit),
        ("testResilientClass", testResilientClass),
        ("testResilientStruct", testResilientStruct),
        ("testStructLetsAndVars", testStructLetsAndVars),
        ("testSubclassOfResilientClass", testSubclassOfResilientClass),
        ("testTuple", testTuple),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(EnumerateFieldsTests.__allTests__EnumerateFieldsTests),
